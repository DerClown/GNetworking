...
NSString *const kKLineListKeyContext = @"kKLineListKeyContext";
NSString *const kKLineListKeyDate    = @"kKLineListKeyDate";
NSString *const kKLineListKeyMaxHigh = @"kKLineListKeyMaxHigh";
NSString *const kKLineListKeyMinLow  = @"kKLineListKeyMinLow";
NSString *const kKLineListKeyMaxVol  = @"kKLineListKeyMaxVol";
NSString *const kKLineListKeyMinVol  = @"kKLineListKeyMinVol";
...
- (id)manager:(GApiBaseManager *)manager transformData:(id)data {
    ...
    return @{kKLineListKeyDate:dates,
             kKLineListKeyContext:context,
             kKLineListKeyMaxHigh:@(maxHigh),
             kKLineListKeyMinLow:@(minLow),
             kKLineListKeyMaxVol:@(maxVol),
             kKLineListKeyMinVol:@(minVol)
             };
}
